...
interface ChangePhoneScreenProps {
  /** Current phone number, shown for context. */
  currentPhone?: string;
  /** Requests the OTP for the new number. Throw to show the error and let the user retry. */
  onSubmit: (newPhoneNumber: string) => Promise<void>;
  /** Called once the OTP has been requested successfully. */
  onComplete?: (newPhoneNumber: string) => void;
  onBack?: () => void;
}
...
export const ChangePhoneScreen: React.FC<ChangePhoneScreenProps> = ({
  ...
  const handleContinue = async () => {
    ...
    if (!trimmed) {
      setFieldError('New phone number is required');
      return;
    }
        ...
        >
          <View style={styles.headingBlock}>
            ...
            <Text style={styles.subheadline}>
              {currentPhone
                ? `Currently ${currentPhone}. We'll text a code to your new number to confirm it.`
